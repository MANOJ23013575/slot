...
<html>
    ...
    <body class="table">
        <center>
            ...
            <h2 class="name" style="color: rgba(21, 90, 38, 0.902);"> TIME TABLE MANOJ K (212222223001)</h2>
...
.table1{
    background-color: rgb(225, 213, 197);
    
}
.table2{
    background-color: rgb(180, 204, 84);
}    
.dt{
...
.mkmk
{
    background-color: rgb(14, 192, 205); color: aliceblue;
}
```
## OUTPUT
![alt text](<Screenshot 2024-03-27 152956.png>)
